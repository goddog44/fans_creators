    ...
    <RoleShell>
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-ink-500">{notifs.filter((n) => !n.read).length} unread</p>
        </div>
        ...
        <div className="space-y-2">
          {notifs.map((n) => {
            ...
            return (
              ...
              >
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${n.read ? 'bg-ink-100 text-ink-500' : 'bg-brand-100 text-brand-600'}`}>
